...
import com.example.socialize.Activities.EditNameActivity
...
import com.example.socialize.ViewModels.ProfileViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        profileViewModels.getUser().observe(viewLifecycleOwner, Observer { userModel ->
            profileBinding.userModel = userModel
                profileBinding.txtProfileName.text
...
//            }
            ...
            profileBinding.editProfileNamePencil.setOnClickListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            100 -> {
                val userName : String? = data?.getStringExtra("name")
    ...
    private fun uploadImage(imageUri: Uri) {
        ...
        storageReference.child(AppConstants.UID + AppConstants.PATH).putFile(imageUri)
