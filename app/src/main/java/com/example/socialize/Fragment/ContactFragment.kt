...
import com.example.socialize.Adapter.ContactAdapter
...
import com.example.socialize.databinding.FragmentContactBinding
...
class ContactFragment : Fragment() {
    ...
    private fun getAppContact(mobileContact: java.util.ArrayList<UserModel>) {
