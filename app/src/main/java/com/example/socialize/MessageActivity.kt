...
import com.example.socialize.Activities.UserInfoActivity
import com.example.socialize.Constants.AppConstants
import com.example.socialize.Permission.AppPermission
import com.example.socialize.Services.SendMediaService
import com.example.socialize.Util.AppUtil
import com.example.socialize.databinding.ActivityMessageBinding
import com.example.socialize.databinding.LeftItemLayoutBinding
import com.example.socialize.databinding.RightItemLayoutBinding
...
//                activityMessageBinding.messageRecyclerView.adapter = firebaseRecyclerAdapter
    ...
    private fun sendMessage(message: String) {
        ...
        if (chatId == null)
            ...
            msgText.text.clear()
            activityMessageBinding.messageRecyclerView.scrollToPosition(firebaseRecyclerAdapter!!.itemCount - 1)
